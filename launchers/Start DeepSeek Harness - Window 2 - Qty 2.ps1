...
$env:DSH_STORAGE_ROOT = 'C:\Users\mgamb\.dsh\storages-w2'
& 'B:\npm-global\dsh.cmd' --profile web --patch 'B:\AI\DeepSeekHarness\patches\storage-root-per-window.patch.yml' --port 3081
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "Harness (Window 2, port 3081) exited with code $LASTEXITCODE." -ForegroundColor Red
