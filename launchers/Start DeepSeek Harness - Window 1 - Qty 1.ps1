...
$env:DSH_STORAGE_ROOT = 'C:\Users\mgamb\.dsh\storages-w1'
& 'B:\npm-global\dsh.cmd' --profile web --patch 'B:\AI\DeepSeekHarness\patches\storage-root-per-window.patch.yml' --port 3080
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "Harness (Window 1, port 3080) exited with code $LASTEXITCODE." -ForegroundColor Red
